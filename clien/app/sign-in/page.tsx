      ...
      <div className="relative z-10 w-full max-w-md bg-white rounded-2xl shadow-2xl overflow-hidden">
        ...
        <div className="bg-linear-to-r from-[#009639] to-[#00C853] px-6 py-8 text-center">
          ...
          <p className="text-white/90 text-sm">
            Agrobankning Intellektual Fermer Yordamchisi
          </p>
        </div>
        ...
        <div className="px-6 py-8">
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
            <InputField
              ...
              register={register}
              error={errors.email}
              validation={{ required: "Email kerak!" }}
            />
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full mt-6 px-4 py-3 text-base font-medium text-white bg-[#009639] hover:bg-[#00796B] rounded-lg transition-all transform hover:-translate-y-0.5 disabled:opacity-70 flex items-center justify-center gap-2"
            >
              {isSubmitting ? (
                <>
          ...
          <Link href={"/sign-up"} className="block text-center pt-6">
            <button className="text-[#009639] hover:text-[#00796B] font-medium transition-colors">
              Ro'yxatdan o'tish
            </button>
          </Link>
        </div>
